    ...
    <div class="container mx-auto px-4 py-8">
      <div class="mb-8">
        <div class="relative max-w-2xl mx-auto">
          <span
            class="icon-[lucide--search] absolute left-3 top-1/2 -translate-y-1/2 w-5 h-5 text-gray-400"
          ></span>
          <input
            type="text"
      ...
      <div class="mb-8">
        <div class="flex items-center gap-6 mb-4">
          ...
          <Button @click="selectedCategory = null" variant="ghost" size="xs">
            Limpiar
          </Button>
        </div>
          ...
          >
            ...
            >
              ...
              <div class="p-4">
                ...
                <div
                  class="flex items-center justify-between text-sm mb-2 text-gray-600"
                >
                  <span class="flex items-center gap-1">
                    <span
                      class="icon-[lucide--star] w-4 h-4 text-yellow-400 fill-yellow-400"
                    ></span>
...
const { vendors, selectedVendor, loading, searchQuery, selectedCategory } =
  useVendor();
...
const topVendors = computed(() =>
  vendors.value.filter((v) => v.rating?.average >= 4.5 && v.active).slice(0, 4)
);
