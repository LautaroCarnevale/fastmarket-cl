  ...
  <div class="min-h-screen bg-gray-50 py-8">
    <div class="container mx-auto px-4 max-w-6xl">
      <div class="mb-6 flex items-center gap-2 text-sm text-gray-700">
        <RouterLink to="/marketplace" class="hover:text-orange-500">
          Marketplace
        </RouterLink>
      ...
      <div v-else class="grid lg:grid-cols-3 gap-8">
        ...
        >
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-4">
              <div>
                <p>{{ addressClient.street + ', ' + addressClient.city + ', ' + addressClient.province }}</p>
              </div>
          ...
          <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6">
            ...
            <Field name="paymentMethod" v-slot="{ field, errorMessage }">
              <div class="space-y-3">
                <label
          ...
          <Button type="submit" variant="default" size="lg" full-width class="mt-4">
            <span v-if="!isProcessing" class="icon-[lucide--check] w-5 h-5"></span>
...
import { checkoutSchema } from '@/validation/orders/checkoutSchema'
...
// Handler del formulario validado
const onSubmit = (_values: any) => {
  // Si quisieras forzar el método del schema:
  // selectedPaymentMethod.value = _values.paymentMethod
  confirmOrder()
}
